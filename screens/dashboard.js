...
export default class dashboard extends React.Component{
    ...
    displayAddbutton=()=>{
        ...
        return(
        <View>
            <TouchableOpacity style={{backgroundColor:"#7B93E2",borderRadius:30,width:50,height:50,marginLeft:280,marginTop:150}}
          ...
          return(
            <View style={{backgroundColor:"#83C4FF",width:280,height:250,marginTop:42,marginLeft:75,borderRadius:10}}> 
              <Icon
              name='users'
              type="font-awesome"
    ...
    <Text style={{marginTop:0}}>___________________________________________</Text>
